...
class dbConnectorTest {
	...
	void contactAdd() {
		...
		tempDB.insertContact("1", "Chris", "Coons", "1234567890","123 Address Lane", "tempkey");
		
		Assertions.assertThrows(IllegalStateException.class, () -> {
			//Inserting non-unique key of 1
			tempDB.insertContact("1", "Chris", "Coons", "1234567890", "123Address Lane", "tempkey");
		});
	...
	void contactGet() {
		...
		ArrayList<String> tempIds = new ArrayList<String>();
 		dbConnector tempDB = createTestDB();
		tempDB.insertContact("1", "Chris", "Coons", "1234567890","123 Address Lane", "tempkey");
		tempDB.retrieveContacts(tempContacts, tempIds, "tempkey");
	...
	void allContactsDelete() {
		...
		ArrayList<String> tempIds = new ArrayList<String>();
 		dbConnector tempDB = createTestDB();
		tempDB.insertContact("1", "Chris", "Coons", "1234567890","123 Address Lane", "tempkey");
		tempDB.insertContact("2", "Chris", "Coons", "1234567890","123 Address Lane", "tempkey");
		tempDB.retrieveContacts(tempContacts, tempIds, "tempkey");
	...
	void contactUpdate() {
		...
		ArrayList<String> tempIds = new ArrayList<String>();
 		dbConnector tempDB = createTestDB();
		tempDB.insertContact("1", "Chris", "Coons", "1234567890","123 Address Lane", "tempkey");
		tempDB.updateContact("1", "first_name", "Carl", "tempkey");
		tempDB.retrieveContacts(tempContacts, tempIds, "tempkey");
		
		Assertions.assertEquals(tempContacts.get(0).getFirstName(), "Carl");
		
		Assertions.assertThrows(IllegalStateException.class, () -> {
			tempDB.updateContact("1", "wrong", "value", "tempkey");
		});
		cleanUp(tempDB);
	}
